...
class OshaInterpretationsSyncService {
     ...
     */
    async syncInterpretations(maxInterpretations) {
     ...
     */
    async processYearLinks(links, maxInterpretations, alreadyProcessed = 0) {
        const results = [];
        ...
        const chunks = (0, utils_1.chunkArray)(linksToProcess, this.concurrencyLimit);
